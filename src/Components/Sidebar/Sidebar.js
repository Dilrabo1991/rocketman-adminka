...
import { BuyurtmalarIcon, MijozlarIcon, MahsulotlarIcon, SettingsIcon, Class } from '../svg'
...
const items = [
    ...
    { id: 3, link: '/maxsulotlar', name: 'Maxsulotlar', icon: <MahsulotlarIcon /> },
    { id: 4, link: '/takliflar', name: 'Takliflar', icon: <Class /> },
